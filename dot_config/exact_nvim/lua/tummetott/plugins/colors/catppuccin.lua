    ...
    opts = {
        ...
        custom_highlights = function(c)
            ...
            return {
                ...
                CursorLine = { bg = darken(c.surface1, 0.2, c.base) },
                ...
                DiffAdd = { fg = c.overlay1, bg = c.surface0 },
                DiffText = { link = 'DiffAdd' },
                DiffChange = { bg = darken(c.blue, 0.07, c.base) },
                DiffDelete = { fg = c.surface0, bg = c.base },
                DiffColorAdd = { fg = c.surface0, bg = darken(c.teal, 0.7, c.base) },
                DiffColorDelete = { fg = c.surface0, bg = darken(c.peach, 0.8, c.base) },
